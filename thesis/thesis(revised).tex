...
\begin{document}
	...
	\subsubsection {数据预处理}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[height=0.6\textwidth]{abnormal.png} % 表示缩放到文本行的 0.6 倍宽
			\caption{异常节点数据及分布}
			\label{fig:abnormal}
		\end{figure}
	...
	\subsubsection {内层优化问题求解}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[height=0.5\textwidth]{sector_layer.png} % 表示缩放到文本行的 0.5 倍宽
			\caption{节点分层与分区特征}
	...
	\subsubsection{外层优化问题求解}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[height=0.5\textwidth]{curveT1.png} % 表示缩放到文本行的 0.5 倍宽
			\caption{两种内层方法的拟合结果}
			\label{fig:curveT1}
		\end{figure}
	...
	\subsubsection {信号的传播模型}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[height=0.55\textwidth]{reflection.png} % 表示缩放到文本行的 0.4 倍宽
			\caption{信号反射}
	...
	\subsection	{模型求解}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[height=0.4\textwidth]{signedArea.png} % 表示缩放到文本行的 0.4 倍宽
			\caption{三角形面积拆分}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[height=0.4\textwidth]{circtri.png} % 表示缩放到文本行的 0.4 倍宽
